...
router.post('/signup', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, name_1, username, hashedPassword, token, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                token = jsonwebtoken_1.default.sign({ email: email }, process.env.JWT_SECRET || 'secret', { expiresIn: '7d' });
                res.json({
                    message: 'User created',
                    token: token,
                    user: { email: email, name: name_1, username: username },
                });
                return [3 /*break*/, 3];
            case 2:
                error_1 = _b.sent();
